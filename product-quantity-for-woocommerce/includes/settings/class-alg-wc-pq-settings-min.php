...
class Alg_WC_PQ_Settings_Min extends Alg_WC_PQ_Settings_Section {
	...
	function get_settings() {
		return array(
			...
			array(
				'title'    => __( 'Cart total quantity message', 'product-quantity-for-woocommerce' ),
			...
			array(
				'title'    => __( 'Per item quantity', 'product-quantity-for-woocommerce' ) . ' - ' . __( 'All products', 'product-quantity-for-woocommerce' ),
			...
			array(
				'title'    => __( 'Per item quantity', 'product-quantity-for-woocommerce' ) . ' - ' . __( 'Per product', 'product-quantity-for-woocommerce' ),
			...
			array(
				'title'    => __( 'Per item quantity message', 'product-quantity-for-woocommerce' ),
